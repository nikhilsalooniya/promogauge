      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            This Privacy Policy explains how PromoGuage collects, uses, stores, and protects personal information from both creators and campaign participants.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li><strong>Signup:</strong> name, email, phone (optional), country.</li>
              <li><strong>Campaign Participants:</strong> based on lead form settings (e.g., name, email, phone).</li>
              <li><strong>Analytics:</strong> IP address, device type, browser information, spin/scratch behavior.</li>
              <li><strong>Billing:</strong> Payment information processed by third-party gateways.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">2. How We Use Information</h2>
            <p className="text-gray-700 leading-relaxed mb-3">We use collected data to:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Create and manage campaigns</li>
              <li>Send reward/confirmation messages</li>
              <li>Improve platform performance</li>
              <li>Prevent fraud & enforce spin/scratch limits</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Email/SMS/WhatsApp delivery providers</li>
              <li>Hosting and analytics platforms</li>
            </ul>
            <p className="text-gray-700 leading-relaxed mt-3">
              All providers follow standard data protection protocols.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Participant Data</h2>
            <p className="text-gray-700 leading-relaxed mb-3">Campaign creators are responsible for:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Their own privacy terms related to prizes</li>
              <li>Managing user data</li>
              <li>Reward fulfillment</li>
              <li>Consumer rights compliance</li>
            </ul>
            <p className="text-gray-700 leading-relaxed mt-3">
              PromoGuage only provides the platform.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Cookies</h2>
            <p className="text-gray-700 leading-relaxed mb-3">PromoGuage uses cookies to:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Maintain sessions</li>
              <li>Track spin/scratch limits</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li><strong>Lead data:</strong> stored until campaign creator deletes it</li>
              <li><strong>Analytics:</strong> stored up to 24 months</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Data Security</h2>
            <p className="text-gray-700 leading-relaxed mb-3">We use:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>Encrypted storage</li>
              <li>Access controls</li>
              <li>Secure HTTPS-only communication</li>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              We may update this Privacy Policy from time to time. Updates take effect upon posting.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              For questions: <a href="mailto:privacy@promoguage.com" className="text-indigo-600 hover:text-indigo-700 font-medium">privacy@promoguage.com</a>
            </p>
          </section>
        </div>
      </main>
